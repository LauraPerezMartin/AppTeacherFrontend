...
const routes: Routes = [
  ...
  { path: 'registro', component: FormularioComponent, title: 'Registro' },
  ...
  { path: 'dashboard/profe/actualizar', component: FormularioComponent, canActivate: [loginGuard, rolGuard], title: 'Actualizar perfil' },
